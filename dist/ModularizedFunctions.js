...
export class PathValidator {
    ...
    static async pathExists(absolutePath) {
        try {
    ...
    static isDirectory(absolutePath) {
        try {
    ...
    static getDirectoryFiles(absolutePath) {
...
export class LinkProcess {
    ...
    static async validateLinks(links) {
        const linksStatus = await Promise.all(links.map(async (link) => {
            try {
